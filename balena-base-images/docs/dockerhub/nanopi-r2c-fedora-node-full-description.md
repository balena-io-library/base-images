...
[&#x60;18.1.0 (latest)&#x60;, &#x60;17.9.0&#x60;, &#x60;16.15.0&#x60;, &#x60;14.19.2&#x60;, &#x60;12.22.12&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/nanopi-r2c/fedora/)

For more information about this image and its history, please see the [relevant manifest file (`nanopi-r2c-fedora-node`)](https://github.com/balena-io-library/official-images/blob/master/library/nanopi-r2c-fedora-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/nanopi-r2c-fedora-node:latest
...
services:
  node:
    image: "balenalib/nanopi-r2c-fedora-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/nanopi-r2c-fedora-node:latest node your-daemon-or-script.js
```
