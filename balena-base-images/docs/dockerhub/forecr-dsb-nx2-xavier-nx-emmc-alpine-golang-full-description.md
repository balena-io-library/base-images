...
[&#x60;1.20.1 (latest)&#x60;, &#x60;1.19.6&#x60;, &#x60;1.18.10&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/forecr-dsb-nx2-xavier-nx-emmc/alpine/)

For more information about this image and its history, please see the [relevant manifest file (`forecr-dsb-nx2-xavier-nx-emmc-alpine-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/forecr-dsb-nx2-xavier-nx-emmc-alpine-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/forecr-dsb-nx2-xavier-nx-emmc-alpine-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/forecr-dsb-nx2-xavier-nx-emmc-alpine-golang:latest go build -v
```
...
[example-projects]: https://www.balena.io/docs/learn/getting-started/forecr-dsb-nx2-xavier-nx-emmc/go/#example-projects?ref=dockerhub
[getting-started]: https://www.balena.io/docs/learn/getting-started/forecr-dsb-nx2-xavier-nx-emmc/go/?ref=dockerhub
