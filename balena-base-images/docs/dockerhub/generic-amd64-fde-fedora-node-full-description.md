...
[&#x60;18.1.0 (latest)&#x60;, &#x60;17.9.0&#x60;, &#x60;16.15.0&#x60;, &#x60;14.19.2&#x60;, &#x60;12.22.12&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/generic-amd64-fde/fedora/)

For more information about this image and its history, please see the [relevant manifest file (`generic-amd64-fde-fedora-node`)](https://github.com/balena-io-library/official-images/blob/master/library/generic-amd64-fde-fedora-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/generic-amd64-fde-fedora-node:latest
...
services:
  node:
    image: "balenalib/generic-amd64-fde-fedora-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/generic-amd64-fde-fedora-node:latest node your-daemon-or-script.js
```
