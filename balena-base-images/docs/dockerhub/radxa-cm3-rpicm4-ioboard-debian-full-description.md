...
[&#x60;bullseye (latest)&#x60;, &#x60;bookworm&#x60;, &#x60;buster&#x60;, &#x60;sid&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/radxa-cm3-rpicm4-ioboard/debian/)

For more information about this image and its history, please see the [relevant manifest file (`radxa-cm3-rpicm4-ioboard-debian`)](https://github.com/balena-io-library/official-images/blob/master/library/radxa-cm3-rpicm4-ioboard-debian) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/radxa-cm3-rpicm4-ioboard-debian:latest
