...
[&#x60;19.4.0 (latest)&#x60;, &#x60;18.13.0&#x60;, &#x60;16.19.0&#x60;, &#x60;14.21.2&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/forecr-dsb-nx2-xavier-nx-emmc/alpine/)

For more information about this image and its history, please see the [relevant manifest file (`forecr-dsb-nx2-xavier-nx-emmc-alpine-node`)](https://github.com/balena-io-library/official-images/blob/master/library/forecr-dsb-nx2-xavier-nx-emmc-alpine-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/forecr-dsb-nx2-xavier-nx-emmc-alpine-node:latest
...
services:
  node:
    image: "balenalib/forecr-dsb-nx2-xavier-nx-emmc-alpine-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/forecr-dsb-nx2-xavier-nx-emmc-alpine-node:latest node your-daemon-or-script.js
```

[example-projects]: https://www.balena.io/docs/learn/getting-started/forecr-dsb-nx2-xavier-nx-emmc/nodejs/#example-projects?ref=dockerhub
[getting-started]: https://www.balena.io/docs/learn/getting-started/forecr-dsb-nx2-xavier-nx-emmc/nodejs/?ref=dockerhub
