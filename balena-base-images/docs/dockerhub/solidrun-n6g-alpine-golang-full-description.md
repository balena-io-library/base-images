...
[&#x60;1.19.1 (latest)&#x60;, &#x60;1.18.6&#x60;, &#x60;1.17.12&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/solidrun-n6g/alpine/)

For more information about this image and its history, please see the [relevant manifest file (`solidrun-n6g-alpine-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/solidrun-n6g-alpine-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/solidrun-n6g-alpine-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/solidrun-n6g-alpine-golang:latest go build -v
```
