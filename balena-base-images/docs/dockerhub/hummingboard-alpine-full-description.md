...
[&#x60;3.18 (latest)&#x60;, &#x60;3.17&#x60;, &#x60;3.16&#x60;, &#x60;3.15&#x60;, &#x60;3.14&#x60;, &#x60;3.13&#x60;, &#x60;3.12&#x60;, &#x60;edge&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/hummingboard/alpine/)

For more information about this image and its history, please see the [relevant manifest file (`hummingboard-alpine`)](https://github.com/balena-io-library/official-images/blob/master/library/hummingboard-alpine) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/hummingboard-alpine:latest
