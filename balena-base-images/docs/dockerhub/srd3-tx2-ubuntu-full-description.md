...
[&#x60;bionic (latest)&#x60;, &#x60;cosmic&#x60;, &#x60;xenial&#x60;, &#x60;disco&#x60;, &#x60;eoan&#x60;, &#x60;focal&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/srd3-tx2/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`srd3-tx2-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/srd3-tx2-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/srd3-tx2-ubuntu:latest
