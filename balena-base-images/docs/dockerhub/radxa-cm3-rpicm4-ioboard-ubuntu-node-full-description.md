...
[&#x60;19.6.0 (latest)&#x60;, &#x60;18.14.0&#x60;, &#x60;16.19.0&#x60;, &#x60;14.21.2&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/radxa-cm3-rpicm4-ioboard/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`radxa-cm3-rpicm4-ioboard-ubuntu-node`)](https://github.com/balena-io-library/official-images/blob/master/library/radxa-cm3-rpicm4-ioboard-ubuntu-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/radxa-cm3-rpicm4-ioboard-ubuntu-node:latest
...
services:
  node:
    image: "balenalib/radxa-cm3-rpicm4-ioboard-ubuntu-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/radxa-cm3-rpicm4-ioboard-ubuntu-node:latest node your-daemon-or-script.js
```
