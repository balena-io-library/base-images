...
[&#x60;bionic (latest)&#x60;, &#x60;cosmic&#x60;, &#x60;artful&#x60;, &#x60;xenial&#x60;, &#x60;trusty&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/stem-x86-32/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`stem-x86-32-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/stem-x86-32-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/stem-x86-32-ubuntu:latest
