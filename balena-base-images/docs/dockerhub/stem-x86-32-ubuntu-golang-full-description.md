...
[&#x60;1.12.7 (latest)&#x60;, &#x60;1.11.12&#x60;, &#x60;1.10.8&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/stem-x86-32/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`stem-x86-32-ubuntu-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/stem-x86-32-ubuntu-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/stem-x86-32-ubuntu-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/stem-x86-32-ubuntu-golang:latest go build -v
```
