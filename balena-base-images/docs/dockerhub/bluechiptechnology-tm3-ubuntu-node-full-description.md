...
[&#x60;20.12.0&#x60;, &#x60;19.6.1 (latest)&#x60;, &#x60;18.14.1&#x60;, &#x60;16.19.1&#x60;, &#x60;14.21.3&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/bluechiptechnology-tm3/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`bluechiptechnology-tm3-ubuntu-node`)](https://github.com/balena-io-library/official-images/blob/master/library/bluechiptechnology-tm3-ubuntu-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/bluechiptechnology-tm3-ubuntu-node:latest
...
services:
  node:
    image: "balenalib/bluechiptechnology-tm3-ubuntu-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/bluechiptechnology-tm3-ubuntu-node:latest node your-daemon-or-script.js
```

[example-projects]: https://www.balena.io/docs/learn/getting-started/bluechiptechnology-tm3/nodejs/#example-projects?ref=dockerhub
[getting-started]: https://www.balena.io/docs/learn/getting-started/bluechiptechnology-tm3/nodejs/?ref=dockerhub
