...
[&#x60;16.1.0 (latest)&#x60;, &#x60;15.14.0&#x60;, &#x60;14.16.1&#x60;, &#x60;12.21.1&#x60;, &#x60;10.24.1&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/floyd-nano/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`floyd-nano-ubuntu-node`)](https://github.com/balena-io-library/official-images/blob/master/library/floyd-nano-ubuntu-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/floyd-nano-ubuntu-node:latest
...
services:
  node:
    image: "balenalib/floyd-nano-ubuntu-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/floyd-nano-ubuntu-node:latest node your-daemon-or-script.js
```
