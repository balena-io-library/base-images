...
[&#x60;1.20.1 (latest)&#x60;, &#x60;1.19.6&#x60;, &#x60;1.18.10&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/iotdin-imx8p-d1d8/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`iotdin-imx8p-d1d8-ubuntu-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/iotdin-imx8p-d1d8-ubuntu-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/iotdin-imx8p-d1d8-ubuntu-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/iotdin-imx8p-d1d8-ubuntu-golang:latest go build -v
```
