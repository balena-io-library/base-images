...
[&#x60;18.3.0 (latest)&#x60;, &#x60;17.9.1&#x60;, &#x60;16.15.1&#x60;, &#x60;14.19.3&#x60;, &#x60;12.22.12&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/asus-tinker-edge-t/alpine/)
...
FROM balenalib/asus-tinker-edge-t-alpine-node:latest
...
services:
  node:
    image: "balenalib/asus-tinker-edge-t-alpine-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/asus-tinker-edge-t-alpine-node:latest node your-daemon-or-script.js
```
