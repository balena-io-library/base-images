...
[&#x60;18.3.0 (latest)&#x60;, &#x60;17.9.1&#x60;, &#x60;16.15.1&#x60;, &#x60;14.19.3&#x60;, &#x60;12.22.12&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/raspberrypicm4-ioboard/debian/)

For more information about this image and its history, please see the [relevant manifest file (`raspberrypicm4-ioboard-debian-node`)](https://github.com/balena-io-library/official-images/blob/master/library/raspberrypicm4-ioboard-debian-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/raspberrypicm4-ioboard-debian-node:latest
...
services:
  node:
    image: "balenalib/raspberrypicm4-ioboard-debian-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/raspberrypicm4-ioboard-debian-node:latest node your-daemon-or-script.js
```
