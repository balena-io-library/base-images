...
[&#x60;1.16.3 (latest)&#x60;, &#x60;1.15.11&#x60;, &#x60;1.14.14&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/edison/fedora/)

For more information about this image and its history, please see the [relevant manifest file (`edison-fedora-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/edison-fedora-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/edison-fedora-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/edison-fedora-golang:latest go build -v
```
