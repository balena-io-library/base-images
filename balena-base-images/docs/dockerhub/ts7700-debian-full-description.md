...
[&#x60;buster (latest)&#x60;, &#x60;bullseye&#x60;, &#x60;jessie&#x60;, &#x60;stretch&#x60;, &#x60;sid&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/ts7700/debian/)

For more information about this image and its history, please see the [relevant manifest file (`ts7700-debian`)](https://github.com/balena-io-library/official-images/blob/master/library/ts7700-debian) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/ts7700-debian:latest
