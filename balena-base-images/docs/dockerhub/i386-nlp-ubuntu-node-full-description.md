...
[&#x60;11.14.0 (latest)&#x60;, &#x60;10.15.3&#x60;, &#x60;9.11.2&#x60;, &#x60;8.15.1&#x60;, &#x60;6.17.1&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/i386-nlp/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`i386-nlp-ubuntu-node`)](https://github.com/balena-io-library/official-images/blob/master/library/i386-nlp-ubuntu-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/i386-nlp-ubuntu-node:latest
...
services:
  node:
    image: "balenalib/i386-nlp-ubuntu-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/i386-nlp-ubuntu-node:latest node your-daemon-or-script.js
```
