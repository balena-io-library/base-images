...
[&#x60;12.10.0 (latest)&#x60;, &#x60;12.9.1&#x60;, &#x60;11.15.0&#x60;, &#x60;10.16.3&#x60;, &#x60;9.11.2&#x60;, &#x60;8.16.1&#x60;, &#x60;6.17.1&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/j120-tx2/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`j120-tx2-ubuntu-node`)](https://github.com/balena-io-library/official-images/blob/master/library/j120-tx2-ubuntu-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/j120-tx2-ubuntu-node:latest
...
services:
  node:
    image: "balenalib/j120-tx2-ubuntu-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/j120-tx2-ubuntu-node:latest node your-daemon-or-script.js
```
