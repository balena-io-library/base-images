...
[&#x60;1.12.6 (latest)&#x60;, &#x60;1.11.11&#x60;, &#x60;1.10.8&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/stem-x86-32/alpine/)

For more information about this image and its history, please see the [relevant manifest file (`stem-x86-32-alpine-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/stem-x86-32-alpine-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/stem-x86-32-alpine-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/stem-x86-32-alpine-golang:latest go build -v
```
