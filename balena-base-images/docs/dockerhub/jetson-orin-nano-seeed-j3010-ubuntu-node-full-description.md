...
[&#x60;20.12.0&#x60;, &#x60;19.6.1 (latest)&#x60;, &#x60;18.14.1&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/jetson-orin-nano-seeed-j3010/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`jetson-orin-nano-seeed-j3010-ubuntu-node`)](https://github.com/balena-io-library/official-images/blob/master/library/jetson-orin-nano-seeed-j3010-ubuntu-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/jetson-orin-nano-seeed-j3010-ubuntu-node:latest
...
services:
  node:
    image: "balenalib/jetson-orin-nano-seeed-j3010-ubuntu-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/jetson-orin-nano-seeed-j3010-ubuntu-node:latest node your-daemon-or-script.js
```

[example-projects]: https://www.balena.io/docs/learn/getting-started/jetson-orin-nano-seeed-j3010/nodejs/#example-projects?ref=dockerhub
[getting-started]: https://www.balena.io/docs/learn/getting-started/jetson-orin-nano-seeed-j3010/nodejs/?ref=dockerhub
