...
[&#x60;18.1.0 (latest)&#x60;, &#x60;17.9.0&#x60;, &#x60;16.15.0&#x60;, &#x60;14.19.2&#x60;, &#x60;12.22.12&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/aio-3288c/fedora/)
...
FROM balenalib/aio-3288c-fedora-node:latest
...
services:
  node:
    image: "balenalib/aio-3288c-fedora-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/aio-3288c-fedora-node:latest node your-daemon-or-script.js
```
