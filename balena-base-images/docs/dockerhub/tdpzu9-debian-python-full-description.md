...
[&#x60;3.11.2 (latest)&#x60;, &#x60;3.10.10&#x60;, &#x60;3.9.16&#x60;, &#x60;3.8.16&#x60;, &#x60;3.7.16&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/python/tdpzu9/debian/)
...
```dockerfile
FROM balenalib/tdpzu9-debian-python:latest
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/tdpzu9-debian-python:latest python your-daemon-or-script.py
```
