...
[&#x60;1.17.4 (latest)&#x60;, &#x60;1.16.11&#x60;, &#x60;1.15.15&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/rockpi-4b-rk3399/alpine/)

For more information about this image and its history, please see the [relevant manifest file (`rockpi-4b-rk3399-alpine-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/rockpi-4b-rk3399-alpine-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/rockpi-4b-rk3399-alpine-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/rockpi-4b-rk3399-alpine-golang:latest go build -v
```
...
[example-projects]: https://www.balena.io/docs/learn/getting-started/rockpi-4b-rk3399/go/#example-projects?ref=dockerhub
[getting-started]: https://www.balena.io/docs/learn/getting-started/rockpi-4b-rk3399/go/?ref=dockerhub
