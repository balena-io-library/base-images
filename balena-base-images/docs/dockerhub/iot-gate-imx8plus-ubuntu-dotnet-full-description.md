...
[&#x60;7.0-sdk&#x60;, &#x60;7.0-runtime&#x60;, &#x60;7.0-aspnet&#x60;, &#x60;6.0-sdk&#x60;, &#x60;6.0-runtime&#x60;, &#x60;6.0-aspnet&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/dotnet/iot-gate-imx8plus/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`iot-gate-imx8plus-ubuntu-dotnet`)](https://github.com/balena-io-library/official-images/blob/master/library/iot-gate-imx8plus-ubuntu-dotnet) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/iot-gate-imx8plus-ubuntu-dotnet:latest
...
services:
  dotnet:
    image: "balenalib/iot-gate-imx8plus-ubuntu-dotnet:latest"
    user: "dotnet"
