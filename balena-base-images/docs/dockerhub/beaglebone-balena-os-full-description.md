...
[](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/beaglebone/balena-os/)

For more information about this image and its history, please see the [relevant manifest file (`beaglebone-balena-os`)](https://github.com/balena-io-library/official-images/blob/master/library/beaglebone-balena-os) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/beaglebone-balena-os:latest
