...
[&#x60;jammy (latest)&#x60;, &#x60;focal&#x60;, &#x60;impish&#x60;, &#x60;xenial&#x60;, &#x60;bionic&#x60;, &#x60;kinetic&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/orangepi-plus2/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`orangepi-plus2-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/orangepi-plus2-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/orangepi-plus2-ubuntu:latest
