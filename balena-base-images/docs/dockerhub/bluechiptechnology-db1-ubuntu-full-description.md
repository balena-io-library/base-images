...
[&#x60;noble (latest)&#x60;, &#x60;jammy&#x60;, &#x60;focal&#x60;, &#x60;xenial&#x60;, &#x60;bionic&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/bluechiptechnology-db1/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`bluechiptechnology-db1-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/bluechiptechnology-db1-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/bluechiptechnology-db1-ubuntu:latest
