...
[&#x60;12.10.0 (latest)&#x60;, &#x60;12.9.1&#x60;, &#x60;11.15.0&#x60;, &#x60;10.16.3&#x60;, &#x60;9.11.2&#x60;, &#x60;8.16.1&#x60;, &#x60;6.17.1&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/ccon-01/fedora/)

For more information about this image and its history, please see the [relevant manifest file (`ccon-01-fedora-node`)](https://github.com/balena-io-library/official-images/blob/master/library/ccon-01-fedora-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/ccon-01-fedora-node:latest
...
services:
  node:
    image: "balenalib/ccon-01-fedora-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/ccon-01-fedora-node:latest node your-daemon-or-script.js
```

[example-projects]: https://www.balena.io/docs/learn/getting-started/ccon-01/nodejs/#example-projects?ref=dockerhub
[getting-started]: https://www.balena.io/docs/learn/getting-started/ccon-01/nodejs/?ref=dockerhub
