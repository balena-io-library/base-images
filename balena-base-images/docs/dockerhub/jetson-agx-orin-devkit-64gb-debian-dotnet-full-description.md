...
[&#x60;7.0-sdk&#x60;, &#x60;7.0-runtime&#x60;, &#x60;7.0-aspnet&#x60;, &#x60;6.0-sdk&#x60;, &#x60;6.0-runtime&#x60;, &#x60;6.0-aspnet&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/dotnet/jetson-agx-orin-devkit-64gb/debian/)

For more information about this image and its history, please see the [relevant manifest file (`jetson-agx-orin-devkit-64gb-debian-dotnet`)](https://github.com/balena-io-library/official-images/blob/master/library/jetson-agx-orin-devkit-64gb-debian-dotnet) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/jetson-agx-orin-devkit-64gb-debian-dotnet:latest
...
services:
  dotnet:
    image: "balenalib/jetson-agx-orin-devkit-64gb-debian-dotnet:latest"
    user: "dotnet"
