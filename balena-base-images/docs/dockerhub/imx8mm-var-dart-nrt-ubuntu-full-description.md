...
[&#x60;bionic (latest)&#x60;, &#x60;cosmic&#x60;, &#x60;xenial&#x60;, &#x60;disco&#x60;, &#x60;eoan&#x60;, &#x60;focal&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/imx8mm-var-dart-nrt/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`imx8mm-var-dart-nrt-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/imx8mm-var-dart-nrt-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/imx8mm-var-dart-nrt-ubuntu:latest
