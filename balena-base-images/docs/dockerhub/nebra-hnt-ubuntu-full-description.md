...
[&#x60;bionic (latest)&#x60;, &#x60;cosmic&#x60;, &#x60;xenial&#x60;, &#x60;disco&#x60;, &#x60;eoan&#x60;, &#x60;focal&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/nebra-hnt/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`nebra-hnt-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/nebra-hnt-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/nebra-hnt-ubuntu:latest
