...
[&#x60;jammy (latest)&#x60;, &#x60;focal&#x60;, &#x60;impish&#x60;, &#x60;xenial&#x60;, &#x60;bionic&#x60;, &#x60;kinetic&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/via-vab820-quad/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`via-vab820-quad-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/via-vab820-quad-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/via-vab820-quad-ubuntu:latest
