...
[&#x60;5.0-sdk (latest)&#x60;, &#x60;5.0-runtime&#x60;, &#x60;5.0-aspnet&#x60;, &#x60;3.1-sdk&#x60;, &#x60;3.1-runtime&#x60;, &#x60;3.1-aspnet&#x60;, &#x60;2.1-sdk&#x60;, &#x60;2.1-runtime&#x60;, &#x60;2.1-aspnet&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/dotnet/jetson-xavier-nx-devkit-seeed-2mic-hat/debian/)

For more information about this image and its history, please see the [relevant manifest file (`jetson-xavier-nx-devkit-seeed-2mic-hat-debian-dotnet`)](https://github.com/balena-io-library/official-images/blob/master/library/jetson-xavier-nx-devkit-seeed-2mic-hat-debian-dotnet) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/jetson-xavier-nx-devkit-seeed-2mic-hat-debian-dotnet:latest
...
services:
  dotnet:
    image: "balenalib/jetson-xavier-nx-devkit-seeed-2mic-hat-debian-dotnet:latest"
    user: "dotnet"
