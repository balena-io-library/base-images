...
[&#x60;jammy (latest)&#x60;, &#x60;focal&#x60;, &#x60;impish&#x60;, &#x60;xenial&#x60;, &#x60;bionic&#x60;, &#x60;kinetic&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/etcher-pro/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`etcher-pro-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/etcher-pro-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/etcher-pro-ubuntu:latest
