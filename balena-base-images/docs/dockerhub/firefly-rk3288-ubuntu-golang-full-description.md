...
[&#x60;1.16.3 (latest)&#x60;, &#x60;1.15.11&#x60;, &#x60;1.14.14&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/firefly-rk3288/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`firefly-rk3288-ubuntu-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/firefly-rk3288-ubuntu-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/firefly-rk3288-ubuntu-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/firefly-rk3288-ubuntu-golang:latest go build -v
```
