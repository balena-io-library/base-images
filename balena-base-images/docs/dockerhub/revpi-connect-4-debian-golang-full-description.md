...
[&#x60;1.20.1 (latest)&#x60;, &#x60;1.19.6&#x60;, &#x60;1.18.10&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/golang/revpi-connect-4/debian/)

For more information about this image and its history, please see the [relevant manifest file (`revpi-connect-4-debian-golang`)](https://github.com/balena-io-library/official-images/blob/master/library/revpi-connect-4-debian-golang) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/revpi-connect-4-debian-golang:latest
...
```console
$ docker run --rm -v "$PWD":/usr/src/myapp -w /usr/src/myapp balenalib/revpi-connect-4-debian-golang:latest go build -v
```
