...
[&#x60;34 (latest)&#x60;, &#x60;35&#x60;, &#x60;33&#x60;, &#x60;32&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/n310-tx2/fedora/)

For more information about this image and its history, please see the [relevant manifest file (`n310-tx2-fedora`)](https://github.com/balena-io-library/official-images/blob/master/library/n310-tx2-fedora) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/n310-tx2-fedora:latest
