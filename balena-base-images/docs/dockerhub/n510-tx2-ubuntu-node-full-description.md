...
[&#x60;14.0.0 (latest)&#x60;, &#x60;13.13.0&#x60;, &#x60;12.16.2&#x60;, &#x60;11.15.0&#x60;, &#x60;10.20.0&#x60;, &#x60;9.11.2&#x60;, &#x60;8.17.0&#x60;, &#x60;6.17.1&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/node/n510-tx2/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`n510-tx2-ubuntu-node`)](https://github.com/balena-io-library/official-images/blob/master/library/n510-tx2-ubuntu-node) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
FROM balenalib/n510-tx2-ubuntu-node:latest
...
services:
  node:
    image: "balenalib/n510-tx2-ubuntu-node:latest"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app balenalib/n510-tx2-ubuntu-node:latest node your-daemon-or-script.js
```
