...
[&#x60;bionic (latest)&#x60;, &#x60;cosmic&#x60;, &#x60;artful&#x60;, &#x60;xenial&#x60;, &#x60;trusty&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/ccon-01/ubuntu/)

For more information about this image and its history, please see the [relevant manifest file (`ccon-01-ubuntu`)](https://github.com/balena-io-library/official-images/blob/master/library/ccon-01-ubuntu) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/ccon-01-ubuntu:latest
