...
[&#x60;34 (latest)&#x60;, &#x60;35&#x60;, &#x60;33&#x60;, &#x60;32&#x60;](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/photon-tx2-nx/fedora/)

For more information about this image and its history, please see the [relevant manifest file (`photon-tx2-nx-fedora`)](https://github.com/balena-io-library/official-images/blob/master/library/photon-tx2-nx-fedora) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/photon-tx2-nx-fedora:latest
