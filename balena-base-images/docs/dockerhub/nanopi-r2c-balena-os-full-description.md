...
[](https://github.com/balena-io-library/base-images/tree/master/balena-base-images/device-base/nanopi-r2c/balena-os/)

For more information about this image and its history, please see the [relevant manifest file (`nanopi-r2c-balena-os`)](https://github.com/balena-io-library/official-images/blob/master/library/nanopi-r2c-balena-os) in the [`balena-io-library/official-images` GitHub repo](https://github.com/balena-io-library/official-images).
...
```dockerfile
FROM balenalib/nanopi-r2c-balena-os:latest
