# AUTOGENERATED FILE
FROM balenalib/generic-aarch64-ubuntu:xenial-build
...
RUN for key in \
	...
	&& echo "78237456386d66ac2143a25530dd5b39326a874079ba7c0676a4639e894567c4  node-v$NODE_VERSION-linux-arm64.tar.gz" | sha256sum -c - \
