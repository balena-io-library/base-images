# AUTOGENERATED FILE
FROM balenalib/generic-aarch64-alpine:3.6-build
...
RUN for key in \
	...
	&& echo "42f76198482f885581d98bfe4ca9560857c68d08f5ae078f2584558bd8b4c1a6  node-v$NODE_VERSION-linux-alpine-aarch64.tar.gz" | sha256sum -c - \
