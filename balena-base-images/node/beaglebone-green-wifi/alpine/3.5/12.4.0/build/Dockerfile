# AUTOGENERATED FILE
FROM balenalib/beaglebone-green-wifi-alpine:3.5-build
...
RUN for key in \
	...
	&& echo "d7e40637b1765c286c267fbf7c33fb74d80de106d65fbebbeb52892db67ad7e8  node-v$NODE_VERSION-linux-alpine-armv7hf.tar.gz" | sha256sum -c - \
