# AUTOGENERATED FILE
FROM balenalib/qemux86-64-alpine:edge-build
...
RUN for key in \
	...
	&& echo "272cbc10d4a7cc13dd64d7594299862505119bd197b812b4fb29241c2c834ed3  node-v$NODE_VERSION-linux-alpine-amd64.tar.gz" | sha256sum -c - \
