...
nodeVersions='0.10.22 0.10.48 0.12.18 5.12.0 7.10.1 9.11.2 8.11.4 6.14.4 4.9.1 10.10.0'
...
for target in $targets; do
	for nodeVersion in $nodeVersions; do
		...
		'ccon-01')
			...
			binaryArch='armv7hf'
		;;
		'jetson-tx2'|'jetson-tx1'|'kitra710'|'artik710'|'generic-aarch64'|'orbitty-tx2'|'spacely-tx2')
			binaryUrl=$nodejsUrl
			binaryArch='arm64'
		;;
		esac
